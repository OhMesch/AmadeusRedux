...
# print(video_url)
# print(subtitle_url)
# print(f"mpv '{video_url}' --sub-file='{subtitle_url}' --o=- --of=hls | castnow --address 192.168.86.27 - --tomp4")
...
# mpv '{video_url}' --sub-file='(subtitle_url)' --o=- --of=hls | castnow --address 192.168.86.27 - --tomp4
